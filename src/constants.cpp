...
const char *connected_types[] = {
	...
	"sedit",
	"select new religion",
	"Entering account ID",	// 57
	"Creating new account",
	"Entering account password",
	"Entering code to confirm ownership of account's email",	// 60
	"Accounts screen",
	"Creates password for the new account",
	"Confirms password of the new account",
	"\n"
};
